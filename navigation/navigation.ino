...
int32_t anchors_x[4] = {0, 2850, 2850, 0};               // anchor x-coorindates in mm
int32_t anchors_y[4] = {0, 0, 2950, 2840};                  // anchor y-coordinates in mm
  ...
  if (Serial.available()) {
    ...
    if (commando.length() > 5) {
      ...
      */
      ...
      destX = part.toInt();
      part = commando.substring(posY+1);
      destY = part.toInt();    
