...
uint16_t anchors[4] = {0x6a38,0x6a21, 0x6a40, 0x6a15};     // the network id of the anchors: change these to the network ids of your anchors.
int32_t anchors_x[4] = {0, 2850, 2850, 10};               // anchor x-coorindates in mm
int32_t anchors_y[4] = {0, 2950, 0, 2840};                  // anchor y-coordinates in mm
